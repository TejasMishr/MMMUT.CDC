        ...
        <main className="mt-10 relative z-10">
          ...
          <section className="bg-gray-800 text-gray-200 p-6 sm:p-10 rounded-lg shadow-lg mb-10 ">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white mb-6 flex items-center border-b-4 border-gray-700 pb-2">
              <FaUsers className="mr-4 text-gray-500 text-5xl" /> About the
              Event
            </h2>
            <p className="text-lg sm:text-xl leading-relaxed text-gray-300 mb-8">
              Join us for an inter-college coding competition that pushes your
              coding and teamwork skills to the limit. Compete for prizes and
              prestige!
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
              ...
              <div className="flex flex-col items-start space-y-4 bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 transition duration-300">
                ...
                <p className="text-base sm:text-lg text-gray-300">
                  Solve algorithmic challenges that test your coding abilities
              ...
              <div className="flex flex-col items-start space-y-4 bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 transition duration-300">
                ...
                <p className="text-base sm:text-lg text-gray-300">
                  Work with your team to tackle problems and strategize for
                  success.
                </p>
              </div>
              ...
              <div className="flex flex-col items-start space-y-4 bg-gray-700 p-6 rounded-lg shadow-lg hover:scale-105 transition duration-300">
                ...
                <p className="text-base sm:text-lg text-gray-300">
                  Win awesome prizes and gain recognition as the top coders in
                  the competition.
                </p>
              </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 my-10">
            ...
            {/* Event Details Card */}
            <div
              className="bg-gray-800 text-gray-200 p-6 sm:p-8 rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50 border hover:border-2 border-transparent hover:border-blue-500"
              style={{ margin: "0.5rem" }}
            >
              {" "}
              {/* Added margin */}
            ...
            <div className="bg-gray-800 text-gray-200 p-6 sm:p-8 rounded-lg shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-red-500 hover:shadow-red-500/50 duration-300  will-change-transform">
              ...
              <div>
                <h1 className="text-lg sm:text-xl">Online Round:-</h1>{" "}
                <p className="text-sm sm:text-lg">CodeForces</p>
              </div>
              <div className="mt-2">
                <h1 className="text-lg text-bold sm:text-xl">Offline Round</h1>{" "}
                <p className="text-sm sm:text-lg">ITRC Lab ,MMMUT Gorakhpur</p>{" "}
              </div>
            </div>
          </section>
          {/* Call to Action */}
          <section className="text-center mt-16">
            ...
            <NavLink to="/createTeam" className="block px-4 py-2 ">
