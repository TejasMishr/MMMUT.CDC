const UpperSection = () => {
  return (
    <>
      <div className="grid grid-cols-7 grid-rows-7 gap-0 z-10 h-[100vh] w-[100vw] absolute  ">
        {/* Add sample grid items */}
        {[...Array(49)].map((_, index) => (
          <div
           
            className="border-2 border-gray-900 flex items-center justify-center opacity-5 "
          >
      ...
      <header className="text-white flex flex-col z-20">
        ...
        <div className="flex flex-col items-center justify-center max-w-[80vw] mx-auto text-center font-montserrat flex-1 relative z-10 mt-[100px] px-4">
          ...
          <img
            ...
            alt="Top Left"
            className="absolute -top-20 -left-7 w-16 h-22"
          />
          {/* Top Right Image */}
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg"
            alt="Top Right"
            className="absolute -top-20 -right-7 w-16 h-20"
          />
          {/* Bottom Left Image */}
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg"
            alt="Bottom Left"
            className="absolute bottom-40 left-2 w-16 h-22"
          />
          {/* Bottom Right Image */}
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/1/18/C_Programming_Language.svg"
            alt="Bottom Right"
            className="absolute bottom-40 right-2 w-16 h-20"
          />
          <div className="flex flex-col items-center">
            <h1 className="text-white font-bold xl:text-[64px] lg:text-6xl text-4xl leading-[1.25] z-20 relative whitespace-nowrap">
              <div className="flex justify-center items-center w-full">
                ...
                <span className="inline-block w-full animate-typing overflow-hidden border-r-4 border-white text-[30px] sm:text-[50px]">
                  Code <span className="gradi-theme-text">Create</span> Conquer
                </span>
                <code className="gradi-theme-text">/&gt;</code>
              </div>
            </h1>
